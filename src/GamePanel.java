...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void newApple(){
        appleX = random.nextInt((int)(SCREEN_WIDTH/UNIT_SIZE))*UNIT_SIZE;  //we write limits inside the brackets.
    ...
    public void actionPerformed(ActionEvent e) {
        if(running) {
            move();
            checkApple();
            checkCollisions(); //why and how methods are called without an object here?
        }
        repaint();
